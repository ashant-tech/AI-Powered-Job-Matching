...
class TelegramJobSource:
    def __init__(self):
        ...
        self.channels = [
            ...
            # Additional Ethiopian job channels
            {"name": "Enjera Jobs", "username": "enjerajobs"},
            {"name": "Shega Jobs", "username": "shegajobs"},
            {"name": "EthiopiaWork", "username": "ethiopiawork"},
            {"name": "Addis Zemen Jobs", "username": "addiszemenjobs"},
            {"name": "ET Careers", "username": "etcareers"},
            {"name": "Ezega Jobs", "username": "ezegajobs"},
            {"name": "JobWeb Ethiopia", "username": "jobwebethiopia"},
            {"name": "JustJobSet", "username": "justjobset"},
            {"name": "Palm Jobs", "username": "palmjobs"},
            {"name": "Hawassa Job Board", "username": "hawassajobs"},
            {"name": "Ethio IT Jobs", "username": "ethioitjobs"},
            {"name": "Ethio Bank Jobs", "username": "ethiobankjobs"},
            {"name": "Ethio NGO Jobs", "username": "ethiongojobs"},
            {"name": "Ethio Engineering Jobs", "username": "ethioengineering"},
            {"name": "Ethio Medical Jobs", "username": "ethiomedicaljobs"},
            {"name": "Ethio Teaching Jobs", "username": "ethioteaching"},
            {"name": "Ethio Accounting Jobs", "username": "ethioaccounting"},
            {"name": "Ethio Marketing Jobs", "username": "ethiomarketing"},
            {"name": "Ethio Sales Jobs", "username": "ethiosales"},
            {"name": "Ethio HR Jobs", "username": "ethiohr"},
            {"name": "Ethio Construction Jobs", "username": "ethioconstruction"},
            {"name": "Ethio Agriculture Jobs", "username": "ethioagriculture"},
            {"name": "Ethio Telecom Jobs", "username": "ethiotelecom"},
            {"name": "Ethio Manufacturing Jobs", "username": "ethiomanufacturing"},
            {"name": "Ethio Tourism Jobs", "username": "ethiotourism"},
            {"name": "Ethio Transport Jobs", "username": "ethiotransport"},
            {"name": "Ethio Logistics Jobs", "username": "ethiologistics"},
            {"name": "Ethio Hospitality Jobs", "username": "ethiohospitality"},
            {"name": "Ethio Retail Jobs", "username": "ethioretail"},
            {"name": "Ethio Finance Jobs", "username": "ethiofinance"},
            {"name": "Ethio Insurance Jobs", "username": "ethioinsurance"},
            {"name": "Ethio Real Estate Jobs", "username": "ethiorealestate"},
            {"name": "Ethio Legal Jobs", "username": "ethiolegal"},
            {"name": "Ethio Media Jobs", "username": "ethiomedia"},
            {"name": "Ethio Creative Jobs", "username": "ethiocreative"},
            {"name": "Ethio Startup Jobs", "username": "ethiostartup"},
            {"name": "Ethio Internship Jobs", "username": "ethiointernship"},
            {"name": "Ethio Volunteer Jobs", "username": "ethiovolunteer"},
            {"name": "Ethio Remote Jobs", "username": "ethioremote"},
            {"name": "Ethio Part Time Jobs", "username": "ethioparttime"},
            {"name": "Ethio Full Time Jobs", "username": "ethiofulltime"},
            {"name": "Ethio Contract Jobs", "username": "ethiocontract"},
            {"name": "Ethio Freelance Jobs", "username": "ethiofreelance"},
        ]
